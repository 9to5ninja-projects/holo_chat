        ...
        try {
            ...
            if (!element) {
                ...
                if (capsulesResult && capsulesResult.capsules) {
                    items.push(...capsulesResult.capsules.map((capsule) => {
                ...
                if (annotationsResult && Array.isArray(annotationsResult)) {
                    items.push(...annotationsResult.map((annotation) => {
                        const item = new MemoryItem(`📍 ${annotation.capsule_id}`, 'annotation', vscode.TreeItemCollapsibleState.Collapsed, annotation.source);
...
class MemoryItem extends vscode.TreeItem {
    constructor(label, contextValue, collapsibleState, source) {
